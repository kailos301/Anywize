...
import { selectArchived, selectRouteStatus, getArchivedRoutes } from 'redux/slices/routeSlice';
...
const ArchiveTours = () => {
	...
	const routes = useSelector(selectArchived);
